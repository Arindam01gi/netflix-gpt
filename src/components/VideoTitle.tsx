    ...
    return (
        <div className='flex flex-col justify-center '>
            ...
            <div className='px-36 pt-6 gap-4 flex '>
                ...
                <button className='bg-gray-700 px-12 py-3 text-lg font-semibold rounded-md shadow-md text-white opacity-50 '> <i className="fa-solid fa-play mr-3"></i>More info</button>
            </div>
        </div>
    )
}
